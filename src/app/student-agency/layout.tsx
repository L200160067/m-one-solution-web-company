...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${siteConfig.baseUrl}/student-agency`,
  },
  openGraph: {
    ...
    url: `${siteConfig.baseUrl}/student-agency`,
    type: 'website',
    locale: 'id_ID',
    siteName: 'M-One Solution',
    images: [
      {
        url: `${siteConfig.baseUrl}/og-student-agency.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`${siteConfig.baseUrl}/og-student-agency.png`],
  },
};
