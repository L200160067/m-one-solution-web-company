  ...
  const packages = [
    {
      ...
      benefit:
        "Cocok untuk usaha baru yang ingin punya identitas digital profesional.",
    ...
    },
    {
      ...
      name: "PRO",
      tagline:
        "Performa maksimal dengan optimasi konversi & SEO lokal mendalam.",
      ...
      <Section className="bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight max-w-4xl mx-auto">
            Bawa Usaha Anda Naik Kelas dengan Website Profesional{" "}
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-10 text-center">
            Website profesional untuk membantu UMKM tampil lebih terpercaya,
            mudah ditemukan di Google, dan siap menerima pelanggan dari
            internet.
          </p>
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Tingkatkan Visibilitas, Jangkau Lebih Banyak Pelanggan
            </h2>
            <p className="text-slate-600 text-lg mb-8">
              Kami paham tantangan terbesar UMKM adalah membangun kepercayaan
              konsumen dan menjangkau pasar baru. Kami siap memberikan website
              profesional siap pakai untuk usaha Anda.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={i}
                className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:border-indigo-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
                <div
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">
              Kami bukan sekadar vendor IT. Kami mitra digitalisasi bisnis Anda
              yang fokus pada hasil nyata dan kemudahan penggunaan.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center hover:border-indigo-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-slate-600 text-lg mb-8">
              ...
              sesuaikan dengan fase perkembangan usaha Anda saat ini.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch">
            {packages.map((pkg) => {
              const currentPrice =
                billingCycle === "tahunan" ? pkg.yearlyPrice : pkg.monthlyPrice;
              const currentPeriod =
                billingCycle === "tahunan"
                  ? pkg.yearlyPeriod
                  : pkg.monthlyPeriod;
              ...
              if (pkg.isPopular) {
                return (
                  <div
                    key={pkg.id}
                    className="group relative bg-linear-to-br from-indigo-500 to-blue-600 rounded-3xl p-8 border-2 border-indigo-300 md:-translate-y-4 shadow-xl shadow-indigo-900/30 flex flex-col overflow-visible"
                  >
                    <div className="absolute top-0 right-8 z-10 -translate-y-1/2 bg-white text-indigo-600 font-bold px-4 py-1 rounded-full text-sm shadow-lg">
                      {pkg.badge}
                    </div>
                    ...
                    <div className="relative mb-6 pb-6 border-b border-white/20">
                      <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                        <span className="line-through text-indigo-200 text-sm font-semibold opacity-90">
                          {billingCycle === "tahunan"
                            ? pkg.yearlyOriginalPrice
                            : pkg.monthlyOriginalPrice}
                        </span>
                        <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-yellow-300 text-slate-950 font-black text-xs uppercase tracking-wider shadow-sm -rotate-2">
                          <svg
                            className="w-3 h-3 fill-slate-950 shrink-0"
                            viewBox="0 0 24 24"
                          >
          ...
          <div className="mt-12 text-center text-slate-500 text-sm max-w-2xl mx-auto">
            *Harga dapat disesuaikan berdasarkan kebutuhan dan kompleksitas
            website. Fitur khusus, redesign besar, e-commerce kompleks, sistem
            booking, dashboard, dan integrasi pihak ketiga dapat dikenakan biaya
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                quote:
                  "Dulu pembukuan manual sering selisih. Sekarang dengan sistem dari M-One, laporan penjualan langsung terlihat setiap hari.",
              },
              {
                name: "Mba Sari",
                role: "Founder Kuliner Homemade",
                quote:
                  "Website saya kini muncul di halaman pertama Google untuk kata kunci lokal. Orderan dari internet meningkat signifikan.",
              },
            ].map((testi, i) => (
              <div
                key={i}
      ...
      <Section className="bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 text-lg mb-10">
            Konsultasikan kebutuhan website UMKM Anda secara GRATIS. Tim kami
            siap membantu memilih paket yang paling sesuai.
          </p>
