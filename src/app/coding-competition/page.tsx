...
<section id="ketentuan" className="alt">
  <div className="wrap">
    ...
    <div className="rules-grid reveal">
      ...
      <div className="rule"><span className="rule-num"><span>3</span></span><p>Teknologi yang digunakan: untuk <strong>Kategori Umum</strong> dibebaskan (bahasa pemrograman/framework apapun), sedangkan untuk <strong>Kategori SMP</strong> wajib menggunakan <strong>Native (HTML, CSS, JavaScript)</strong>.</p></div>
