...
export const metadata: Metadata = {
  ...
  description:
    "Tinggalkan cara manual! Jasa pembuatan website toko online dan sistem ERP terjangkau untuk UMKM: manajemen stok, kasir (POS), dan laporan keuangan langsung beres.",
  keywords: [
  ...
  openGraph: {
    title: "Jasa Pembuatan Website & Sistem Kasir (ERP) UMKM | M-One Solution",
    description:
      "Tinggalkan cara manual! Jasa pembuatan website toko online dan sistem ERP terjangkau untuk UMKM.",
  ...
  twitter: {
    ...
    description:
      "Website toko online + sistem kasir & gudang tanpa biaya bulanan untuk UMKM.",
    images: ["/og-erp-umkm.png"],
  },
};
...
export default function JasaERPMPage() {
  const waMessage = encodeURIComponent(
    "Halo M-One, saya tertarik untuk digitalisasi usaha saya (UMKM). Bisa info lebih lanjut?",
  );
  ...
  const jsonLd = {
    ...
    description:
      "Jasa pembuatan website toko online dan sistem ERP terjangkau untuk UMKM.",
    brand: {
      "@type": "Brand",
      name: "M-One Solution",
    },
    ...
    offers: [
      {
        ...
        priceCurrency: "IDR",
        description:
          "Website profil & katalog UMKM lengkap dengan domain dan hosting.",
      ...
      },
      {
        ...
        priceCurrency: "IDR",
        description:
          "Sistem toko online dengan keranjang belanja, payment gateway, dan dashboard order.",
        availability: "https://schema.org/InStock",
        url: `${siteConfig.baseUrl}/layanan/jasa-erp-umkm#harga`,
      },
      {
        ...
        priceCurrency: "IDR",
        description:
          "Aplikasi kasir POS, inventori multi-cabang, dan laporan keuangan realtime.",
        availability: "https://schema.org/InStock",
        url: `${siteConfig.baseUrl}/layanan/jasa-erp-umkm#harga`,
      },
    ],
      ...
      <main className="pt-20 min-h-screen bg-slate-50">
        ...
        <Section className="bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8">
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-10 text-center">
              Mulai dari Website Katalog, Toko Online, hingga Sistem Kasir (POS)
              & Inventori Gudang khusus untuk menaikkan omzet dan merapikan
              pembukuan UMKM Anda.
            </p>
          ...
          <Container>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                Tingkatkan Efisiensi, Kurangi Kebocoran Dana
              </h2>
              <p className="text-slate-600 text-lg mb-8">
                Kami paham masalah terbesar UMKM adalah pencatatan manual yang
                memakan waktu dan sering selisih. Kami siap memberikan alat
                tempur digital untuk Anda.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:border-indigo-100 hover:shadow-md transition-all"
                >
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 ${fitur.bg} ${fitur.color}`}
                  >
          ...
          <Container>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-slate-600 text-lg">
                Kami bukan sekadar vendor IT. Kami mitra digitalisasi bisnis
                Anda yang fokus pada hasil nyata dan kemudahan penggunaan.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center hover:border-indigo-100 hover:shadow-md transition-all"
                >
          ...
          <Container>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Pilih Investasi Digital Anda
              </h2>
              <p className="text-slate-400 text-lg">
                Paket layanan transparan tanpa biaya tersembunyi. Tinggal
                sesuaikan dengan fase perkembanan usaha Anda saat ini.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-slate-800 rounded-3xl p-8 border border-slate-700 hover:border-slate-500 transition-all flex flex-col">
                <div className="mb-6">
                  ...
                  <p className="text-slate-400 text-sm">
                    Untuk usaha yang butuh kartu nama digital & etalase.
                  </p>
                </div>
                <div className="mb-2">
                  <span className="text-4xl font-extrabold">Rp 1 JT</span>
                  <span className="text-slate-400 text-lg">/thn</span>
                </div>
                <p className="text-xs text-slate-500 mb-6">
                  Sudah termasuk domain, hosting, SSL & setup.
                </p>
                <div className="mb-8 flex-1">
                  <ul className="space-y-4 text-slate-300 text-sm">
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0" />{" "}
                      Server Hosting Siap Pakai
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0" />{" "}
                      Desain Web Profil & Kontak
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0" />{" "}
                      Katalog Jasa / Produk Standard
                    </li>
                    <li className="flex items-start gap-3 text-slate-500">
                      <CheckCircle2 className="w-5 h-5 shrink-0" /> (Tanpa Fitur
                      Belanja / Kasir)
                    </li>
                  </ul>
                </div>
                <a
                  href={
                    waLink + "&text=Halo+saya+ingin+tanya+Paket+Go-Online+UMKM"
                  }
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <div className="bg-linear-to-br from-indigo-500 to-blue-600 rounded-3xl p-8 border-2 border-indigo-300 transform md:-translate-y-4 shadow-xl shadow-indigo-900/50 flex flex-col relative">
                <div className="absolute top-0 right-8 z-10 -translate-y-1/2 bg-white text-indigo-600 font-bold px-4 py-1 rounded-full text-sm">
                  PALING LARIS
                </div>
                <div className="mb-6">
                  ...
                  <p className="text-indigo-100 text-sm">
                    Sistem toko online siap jualan untuk butik/retail.
                  </p>
                </div>
                <div className="mb-2">
                ...
                <p className="text-xs text-indigo-200 mb-6">
                  Sudah termasuk domain, hosting, SSL & payment gateway.
                </p>
                <div className="mb-8 flex-1">
                  <ul className="space-y-4 text-white text-sm">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-200 shrink-0" />{" "}
                      Semua Fitur Paket Profil
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-200 shrink-0" />{" "}
                      <b>Sistem Keranjang Belanja</b>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-200 shrink-0" />{" "}
                ...
                <a
                  href={
                    waLink +
                    "&text=Halo+saya+ingin+tanya+Paket+Toko+Online+UMKM"
                  }
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <div className="bg-slate-800 rounded-3xl p-8 border border-slate-700 hover:border-slate-500 transition-all flex flex-col">
                <div className="mb-6">
                  ...
                  <p className="text-slate-400 text-sm">
                    Sistem kasir komplit & multi-cabang (Tanpa Langganan).
                  </p>
                </div>
                <div className="mb-2">
                ...
                <p className="text-xs text-slate-500 mb-6">
                  Sudah termasuk domain, hosting, SSL & training pemakaian.
                </p>
                <div className="mb-8 flex-1">
                  <ul className="space-y-4 text-slate-300 text-sm">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0" />{" "}
                      Aplikasi Kasir (POS) Berbasis Web
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0" />{" "}
                      Pantau Stok Multi-Cabang Gudang
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0" />{" "}
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0" />{" "}
                      Bebas biaya bulanan aplikasi!
                    </li>
                  </ul>
                </div>
                <a
                  href={
                    waLink + "&text=Halo+saya+ingin+tanya+Paket+ERP+Kasir+UMKM"
                  }
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full block text-center py-4 rounded-xl bg-slate-700 hover:bg-slate-600 text-white font-semibold transition-all"
        ...
        <Section className="bg-indigo-50">
          <Container>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                Apa Kata UMKM yang Sudah Bertransformasi?
              </h2>
              <p className="text-slate-600 text-lg">
                Bergabung bersama puluhan UMKM yang kini mengelola bisnisnya
                dengan lebih rapi, cepat, dan profesional.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  quote:
                    "Sistem kasir dan website toko online dari M-One benar-benar memudahkan. Saya bisa pantau stok dan orderan dari HP tanpa ribet.",
                },
                {
                  name: "Pak Budi",
                  role: "Owner Gudang Sembako",
                  quote:
                    "Dulu pembukuan manual sering selisih. Sekarang dengan ERP M-One, laporan laba rugi langsung terlihat setiap hari.",
                },
                {
                  name: "Mba Sari",
                  role: "Founder Kuliner Homemade",
                  quote:
                    "Website katalog dan WhatsApp order otomatis sangat membantu. Pelanggan jadi lebih percaya karena tampilannya profesional.",
                },
              ].map((testi, i) => (
                <div
                  key={i}
        ...
        <Section className="bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                {
                  Q: "Apakah sistem Kasir (POS) ini harus langganan bulanan?",
                  A: "Tidak! Paket ERP Mini kami menggunakan model pembelian sekali bayar untuk fitur utama. Anda hanya membayar biaya perpanjangan server/domain tahunan, yang jauh lebih hemat dibanding langganan aplikasi kasir bulanan.",
                },
                {
                  Q: "Saya gaptek, apakah akan diajari cara pemakaiannya?",
                  A: "Pasti. Tim kami memberikan training online dan panduan video cara memasukkan produk, melayani kasir, hingga membaca laporan keuangan.",
                },
                {
                  Q: "Berapa lama website toko atau sistem kasir saya siap?",
                  A: "Layanan productized kami menjamin sistem siap pakai dalam 7–14 hari kerja setelah Anda memberikan daftar produk/menu awal.",
                },
                {
                  Q: "Apakah harga sudah termasuk domain dan hosting?",
                  A: "Ya. Semua paket sudah include domain (.com / .id), hosting, SSL, dan setup awal. Anda hanya perlu memperpanjang domain & hosting di tahun berikutnya.",
                },
                {
        ...
        <Section className="bg-slate-900 text-white">
          <Container>
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Siap Digitalisasi Usaha Anda?
              </h2>
              <p className="text-slate-400 text-lg mb-10">
                Jangan biarkan pencatatan manual menghambat pertumbuhan bisnis.
                Konsultasikan kebutuhan UMKM Anda secara GRATIS.
              </p>
