    ...
    return (
      <div className="flex flex-col items-center justify-center text-center p-8 bg-green-50 border border-green-200 rounded-3xl h-full min-h-[400px] animate-scale-in">
        ...
        <p className="text-slate-600 mb-6 max-w-sm">
          Pesan Anda sudah siap dikirim via WhatsApp. Silakan klik tombol kirim
          di aplikasi WhatsApp Anda.
        </p>
        <button
          onClick={() => {
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-xs text-slate-400">
        Dengan mengklik kirim, Anda akan diarahkan ke WhatsApp untuk mengirim
        pesan.
      </p>
    </form>
  );
