...
const PRODUCTS: Product[] = [
  {
    ...
    reviewsCount: 142,
    description:
      "Soft butter knit with delicate botanical embroidery & wooden buttons",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuChpmUwFWfR6_PqUh1n8gszItLkCOszeX8DS_zlYz5gg5sArwZ1GFwG3OARgnC0P5j37UtmL3iRcm09gDzyT27htyW-GHNDgXZYPRvcx1AcQ876uezXrr9VSSfebRgFpsP_ZGsT6i8nOpVsWZ9gnLgpy07vJK5kQBvZvlPL59Vmi6aGBewAQj8ltcLKYDtxzaQMTUTYvSjzDlNfA4BUGnRDuGqStU6tJhcQwGJOR39c2nMbPpScTenRHw",
  ...
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuC0RP5zD_wb77JXevRgUiXmQG3V6OdJG3D0U08nBLNWHLpjYE3l3n51x7_U2BEW6rU87hzVmN8YbZifqI8RRCcsuv1FB0ykh0uf-qfcgbuJoMLQ9NMwtAfWtDYfpUxTVfrGNDxVkrrLKCZGu6KXk53ClGbOHJFW-JTLfj3XcomBekiKYDhKLn3-53lDfr7vLf0gSD-CsRhrMODMe85RzKeMSh133EXQ7WS_ymENKLfe53hoMP6UShIubQ",
  ...
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuC6JLB0sSzDBl_p5D6o8iz7ZZ9Snzbyz7XHr9kvZR6QhuRwqKAQC-up26vMzd9HEOHEGXlwFxP0az2mC58NX5XQo0WlwA9e1FWsayCZTT_PEvTnhU32yQmiRmVIJbvgwUeddO8oSp7feLVcSzRDfy1EpYQyLz7oIFzBv4uUqunhhMpFIRNT9WQ4INkQXOIkVr4tYso5iPkqTA5FSeYoWzIdlN3DUGRqPlTNGclmvG8PPaWfws1sML45AA",
  ...
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCmDyT5g6Y_6kK_i6Yb9YglY7QEGPHLr3_MnLMpnwfyFQlAWoFWucKxltoStygxEiI1UkBHCv_Br6-E_0FRcA2AwVsq0CBuzPYK71YfmsQHZoVT1Daf1yw6fSV5GA5Ys6HqoJpsdoBIkV2jVOzwJpDia28KKV-oVcbL06YByCQfZMwKtgeEJdGqeVjI0VRWl_sSBNARAQQ78IX2wORz1YSpA3KebWHG2TcGWdtZ-5wYrljHWh_gd0nkCg",
...
export default function Butik2Page() {
  ...
  const [wishlist, setWishlist] = useState<Set<string>>(
    new Set(["retro-1", "retro-2", "retro-3"]),
  );
  ...
  return (
    <div className="min-h-screen bg-[#fbf6ee] text-[#1e1713] antialiased selection:bg-[#ffdad9] selection:text-[#4a2414]">
      ...
      <aside
        ...
        className="bg-[#2f3e2e] text-[#fbf6ee] py-2.5 px-4 text-xs"
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 font-mono font-medium tracking-wide">
          <div className="flex items-center gap-2 overflow-x-auto custom-scrollbar whitespace-nowrap">
            ...
            <span className="opacity-40">•</span>
            <span className="text-[#fae5b6]">
              FREE SHIPPING SHOPEE &amp; WHATSAPP ORDERS OVER RP 150K
            </span>
          </div>
          <a
            href="#artisan-newsletter"
            className="hidden md:inline-flex items-center gap-1 bg-[#fae5b6] text-[#2f3e2e] px-3.5 py-1 rounded-full text-[11px] font-bold shrink-0 hover:bg-white transition-colors"
          >
          ...
          <div className="h-20 flex items-center justify-between gap-4">
            ...
            <a href="#" className="flex items-center gap-3 shrink-0 group">
              <div className="w-10 h-10 rounded-full bg-[#f5eedf] border border-[#caa885] flex items-center justify-center p-1.5 shadow-sm group-hover:scale-105 transition-transform">
                ...
                >
                  <path
                    d="M20 6C12 6 6 12 6 20C6 28 12 34 20 34C16 31 13 26 13 20C13 14 16 9 20 6Z"
                    fill="#8c4224"
                  />
                  <path
                    d="M22 10C22.5 12.5 24.5 14 27 14.5C24.5 15 22.5 16.5 22 19C21.5 16.5 19.5 15 17 14.5C19.5 14 21.5 12.5 22 10Z"
                    fill="#caa885"
                  />
                </svg>
              </div>
              <div className="flex flex-col">
                <span className="text-[9px] font-mono uppercase tracking-widest text-[#8c4224] font-bold">
                  THE RETRO KNIT
                </span>
                <span className="font-editorial text-2xl sm:text-3xl font-bold tracking-tight text-[#1e1713] leading-none">
                  Sazmoon
                </span>
              </div>
            </a>
            ...
            <nav className="hidden lg:flex items-center gap-1.5 p-1 rounded-full bg-[#f5eedf] border border-[#e4d8c5]">
              ...
              <a
                ...
                className="px-4 py-2 rounded-full text-xs font-bold text-[#6b5d54] hover:bg-[#ebdcc8] hover:text-[#1e1713] transition-all whitespace-nowrap"
              >
                POP-UP SCHEDULE
              </a>
            </nav>
            ...
            <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
              ...
              <div className="hidden md:flex items-center bg-white rounded-full px-3.5 py-1.5 border border-[#e4d8c5] shadow-sm focus-within:border-[#8c4224] transition-all">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="text-[#8c4224] text-xs ml-1"
                  >
                    ✕
                  </button>
                )}
              ...
              <button
                aria-label="Wishlist"
                onClick={() =>
                  alert(`You have ${wishlist.size} saved heirloom pieces!`)
                }
      ...
      <main className="w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 order-2 lg:order-1">
              ...
              <p className="text-base sm:text-lg text-[#6b5d54] max-w-xl leading-relaxed font-normal">
                Slow-crafted floral cardigans, soft ribbed vests, and modest
                silhouettes rooted in warm nostalgic memories. Stitched with
                breathable pure cotton yarn for slow living.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-6 border-t border-[#e4d8c5]">
                <div className="flex items-center gap-2.5 p-3 rounded-2xl bg-white border border-[#e4d8c5]">
                  ...
                  <span className="text-[11px] font-mono font-bold text-[#1e1713]">
              ...
              <div className="relative mx-auto max-w-lg lg:max-w-none">
                ...
                <div className="relative overflow-hidden rounded-[36px] border-2 border-[#caa885] bg-[#f5eedf] shadow-xl">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 sm:right-auto bg-white/95 backdrop-blur-md p-4 rounded-2xl border-2 border-[#caa885] shadow-lg flex items-center justify-between gap-4">
                    <div>
                      <span className="text-[10px] font-mono text-[#8c4224] uppercase font-bold block">
                        HEIRLOOM CABLE CARDIGAN
                      </span>
                      <p className="font-editorial text-lg text-[#1e1713] font-bold">
                        Buttercream Floral • Rp 189k
                      </p>
                    </div>
                    <a
                      href="#catalog"
                      className="w-10 h-10 rounded-full bg-[#723d24] text-white flex items-center justify-center hover:bg-[#4a2414] transition-colors shadow-sm"
                    >
        ...
        <section
          id="catalog"
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t-2 border-[#e4d8c5]"
        >
          {/* Catalog Header */}
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-8">
            <div>
              <span className="text-xs font-mono font-bold tracking-widest text-[#8c4224] uppercase">
                AUTUMN / WINTER 2025
              </span>
              <h2 className="font-editorial text-3xl sm:text-4xl text-[#1e1713] font-bold mt-1">
                The Knit Archive &amp; Modest Cuts
              </h2>
            </div>
            <p className="text-xs sm:text-sm text-[#6b5d54] max-w-md font-normal leading-relaxed">
              Every garment is knitted with skin-friendly cotton threads,
              generous sizing, and heirloom details made to last.
            </p>
          </div>
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-3xl border-2 border-[#e4d8c5]">
              ...
              <p className="mt-2 text-sm font-editorial font-bold text-[#1e1713]">
                  ...
                  >
                    <div className="relative aspect-4/5 overflow-hidden bg-[#f5eedf]">
                      ...
                      <div className="absolute top-3.5 left-3.5">
                        <span
                          className={`px-3 py-1 rounded-full text-[10px] font-mono font-bold uppercase shadow-sm ${product.tagBg} ${product.tagColor}`}
                        >
                          {product.tag}
                        </span>
                      </div>
                    ...
                    <div className="p-5 flex flex-col flex-1 justify-between bg-white">
                      <div>
                        <div className="flex items-center justify-between text-[11px] font-mono text-[#6b5d54] mb-1.5">
                          <span className="font-bold text-[#8c4224] uppercase">
                            {product.subType}
                          </span>
                          <span className="flex items-center gap-0.5">
                            <Star className="w-3 h-3 text-amber-500 fill-amber-500 shrink-0" />
                            <span className="font-bold text-[#1e1713]">
                      ...
                      <div className="mt-5 pt-3.5 border-t border-[#f5eedf] flex items-center justify-between">
                        <div>
                          <span className="text-[10px] font-mono text-[#6b5d54] block uppercase">
                            MEMBERS PRICE
                          </span>
                          <span className="font-editorial text-xl font-bold text-[#1e1713]">
                            {product.priceLabel}
                          </span>
                        </div>
                        <a
          ...
          <div className="mt-12 text-center">
            ...
            <p className="text-xs font-mono text-[#6b5d54] mt-2.5">
              📦 Automatic Free Shipping across Indonesia for orders via Shopee
              &amp; WA concierge.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t-2 border-[#e4d8c5]">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-10">
            <div>
              ...
              <h2 className="font-editorial text-3xl sm:text-4xl text-[#1e1713] font-bold mt-1">
                Visual Journal &amp; Styling Mood
              </h2>
            </div>
            <p className="text-xs sm:text-sm text-[#6b5d54] max-w-md font-normal">
              Effortless layering ideas for bookshop afternoons, tea houses, and
              vintage markets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-3xl p-3 border-2 border-[#e4d8c5] shadow-sm group">
              ...
              <div className="p-4 space-y-1">
                <span className="text-[10px] font-mono text-[#8c4224] font-bold uppercase">
                  LOOK NO. 01
                </span>
                <h3 className="font-editorial text-xl font-bold text-[#1e1713]">
                  The Tokyo Record Store Walk
                </h3>
                <p className="text-xs text-[#6b5d54]">
                  Espresso Cable Knit + Pleated Skirt
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-3 border-2 border-[#e4d8c5] shadow-sm group">
              ...
              <div className="p-4 space-y-1">
                ...
                <h3 className="font-editorial text-xl font-bold text-[#1e1713]">
                  Quiet Seoul Garden Cafe
                </h3>
                <p className="text-xs text-[#6b5d54]">
                  Sage Polo Knit + Wide Cream Denim
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-3 border-2 border-[#e4d8c5] shadow-sm group">
              ...
              <div className="p-4 space-y-1">
                ...
                <p className="text-xs text-[#6b5d54]">
                  Lilac Vest + Vintage Oxford Shirt
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="clubhouse-booths"
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t-2 border-[#e4d8c5]"
        >
          <div className="mb-10">
            ...
            <p className="text-sm text-[#6b5d54] max-w-xl mt-2 font-normal">
              Experience the tactile softness of our pure cotton yarn in person,
              test sizing in vintage mirrors, and claim exclusive club
              souvenirs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="md:w-1/2 p-6 sm:p-8 flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#f5eedf] border border-[#caa885] space-y-1">
                    <p className="text-xs text-[#8c4224] font-mono font-bold">
                      Club Perk:
                    </p>
                    <p className="text-xs text-[#1e1713]">
                      Free Sazmoon Canvas Tote Bag &amp; Sticker Sheet on all
                      on-site orders over Rp 300k.
                    </p>
                  </div>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-xs font-mono font-bold text-[#723d24] hover:text-[#4a2414] transition-colors pt-2"
                >
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              <div className="p-6 rounded-3xl bg-white border-2 border-[#e4d8c5] shadow-sm flex flex-col justify-between flex-1 space-y-3">
                ...
                <p className="text-xs text-[#6b5d54] leading-relaxed">
                  Complimentary herbal tea, full-length warm lighting mirrors,
                  and a polaroid photo memory with every fitting.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t-2 border-[#e4d8c5]">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="font-editorial text-3xl sm:text-4xl text-[#1e1713] font-bold mt-1">
              Captured by our gentle community
            </h2>
            <p className="text-xs text-[#6b5d54] mt-2 font-mono">
              Tag @sazmoon.co on Instagram for a chance to win monthly
              slow-fashion shopping vouchers!
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-3 rounded-2xl border-2 border-[#e4d8c5] shadow-sm hover:-translate-y-1 transition-transform">
              ...
              <div className="pt-2.5 text-center">
                <span className="text-xs font-editorial font-bold text-[#1e1713] block">
                  @amanda_teahouse
                </span>
                <span className="text-[10px] font-mono text-[#6b5d54]">
                  Kyoto Morning Tea
                </span>
              </div>
            </div>
      ...
      <footer
        ...
        className="w-full bg-[#f5eedf] border-t-2 border-[#e4d8c5] mt-16 py-16"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-4 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-[9px] font-mono uppercase tracking-widest text-[#8c4224] font-bold block">
                    THE RETRO KNIT
                  </span>
                  <span className="font-editorial text-2xl font-bold text-[#1e1713]">
                    Sazmoon
                  </span>
                </div>
              </div>
              ...
              <p className="text-xs text-[#6b5d54] leading-relaxed max-w-sm font-normal">
                Handcrafted slow-fashion knitwear for everyday modesty. Inspired
                by 70s-90s Tokyo tea rooms and quiet morning walks in Seoul.
              </p>

              <div className="flex items-center gap-2 pt-1 font-mono text-[10px]">
                <span className="px-3 py-1 rounded-full bg-white border border-[#caa885] text-[#723d24] font-bold">
                  Slow Fashion
                </span>
                <span className="px-3 py-1 rounded-full bg-white border border-[#caa885] text-[#723d24] font-bold">
                  Modest Fits
            ...
            <div className="lg:col-span-2 space-y-3 font-mono text-xs">
              <h4 className="font-bold text-[#1e1713] uppercase tracking-wider">
                LOOKBOOK
              </h4>
              <ul className="space-y-2 text-[#6b5d54]">
                <li>
                  <a
                    href="#catalog"
                    className="hover:text-[#8c4224] transition-colors"
                  >
                    Archive 2024
                  </a>
                </li>
            ...
            <div className="lg:col-span-4 space-y-3">
              <div className="bg-white p-6 rounded-3xl border-2 border-[#caa885] shadow-sm">
                <h4 className="font-editorial text-lg text-[#1e1713] font-bold">
                  The Artisan Club Newsletter
                </h4>
                <p className="text-xs text-[#6b5d54] mt-1 leading-relaxed">
                  Receive vintage catalog drops, secret pop-up invitations, and
                  early lookbook access.
                </p>
                <form
                  id="newsletterForm"
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="shrink-0 px-5 py-2 rounded-full bg-[#723d24] text-white text-xs font-mono font-bold hover:bg-[#4a2414] transition-colors"
                  >
                    Subscribe
                  </button>
                </form>
          ...
          <div className="mt-12 pt-6 border-t border-[#caa885]/60 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] font-mono text-[#6b5d54]">
            <p>
              © 2025 Sazmoon Studio / The Retro Knit Club. Hand-spun with
              patience &amp; mindful stitches.
            </p>
            <div className="flex items-center gap-6">
              <a href="#" className="hover:text-[#1e1713] transition-colors">
                Club Rules
              </a>
              <a href="#" className="hover:text-[#1e1713] transition-colors">
                Privacy Policy
