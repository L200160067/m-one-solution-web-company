...
export function WhatsAppButton({ whatsappNumber }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl hover:shadow-[#25D366]/30 hover:scale-110 active:scale-90 transition-all duration-300 group"
