...
export const metadata: Metadata = {
  ...
  description:
    "Lomba Inovasi Website & AI untuk pelajar SMP, SMA/SMK, mahasiswa, dan umum se-Solo Raya. Total prize pool Rp 3.200.000! Daftar sekarang, kuota terbatas! Diselenggarakan oleh M-One Solution dan Telkomsel.",
  keywords:
    "lomba coding 2026, kompetisi website solo, coding competition sukoharjo, telkomsel coding competition, lomba ai smp sma mahasiswa, m-one solution event",
  alternates: {
  ...
  openGraph: {
    title: "M-ONE Telkomsel Coding Competition 2026 — Pendaftaran",
    description:
      "Bikin Website Inovatif & Keren, Dibantu AI! Terbuka untuk SMP, SMA/SMK, Mahasiswa, & Umum se-Solo Raya.",
...
export default function CompetitionLayout({
  ...
  const jsonLd = {
    ...
    description:
      "Lomba Inovasi Website & AI untuk pelajar SMP, SMA/SMK, mahasiswa, dan umum se-Solo Raya. Total prize pool Rp 3.200.000!",
