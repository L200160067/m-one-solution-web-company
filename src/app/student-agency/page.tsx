...
import {
  studentAgency,
  branding,
  studentAgencyRegisterHref,
  studentAgencyEarlyBirdHref,
} from '@/config/marketing';

const BATCH_DATE = new Date(studentAgency.countdown.targetDate).getTime();
const getTimeLeft = () => {
...
const benefits = studentAgency.benefits;
const steps = studentAgency.steps;
const faqs = studentAgency.faqs;
  ...
  return (
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: '#fafafa' }}>
        ...
        <div className="absolute top-0 right-0 pointer-events-none z-10">
          <svg viewBox="0 0 200 200" width="200" height="200" className="opacity-90">
            <polygon points="160,0 200,0 200,40 200,160 160,200 100,160 160,100" fill={branding.yellowAccent} />
            <polygon points="200,0 200,80 120,0" fill={branding.yellowAccent} />
          </svg>
        </div>
        ...
        <div className="absolute bottom-0 left-0 pointer-events-none z-10">
          <svg viewBox="0 0 200 220" width="200" height="220" className="opacity-90">
            <polygon points="0,220 60,220 60,180 100,140 60,100 100,60 40,0 0,60 40,100 0,140" fill={branding.pinkAccent} />
          </svg>
        </div>
        ...
        <div className="absolute bottom-16 left-0 pointer-events-none z-10">
          <svg viewBox="0 0 100 100" width="100" height="100">
            <polygon points="0,100 40,100 100,40 100,0 60,0 0,60" fill={branding.pinkAccent} opacity="0.7" />
          </svg>
        </div>
        ...
        <div className="relative z-20 flex flex-col items-center text-center px-6 max-w-3xl mx-auto pt-28 pb-20">
          ...
          >
            <h1
              ...
              style={{
                color: branding.yellowAccent,
                WebkitTextStroke: `3px ${branding.pinkAccent}`,
                textShadow: `4px 4px 0 ${branding.pinkAccent}`,
                fontFamily: branding.studentAgencyHeadingFont,
          ...
          >
            <div
              ...
              style={{
                background: '#FFF3A3',
                color: branding.pinkAccent,
                fontFamily: branding.studentAgencyHeadingFont,
                boxShadow: `3px 3px 0 ${branding.pinkAccent}33`,
              }}
            >
              Kalau Mahasiswa
            </div>
            ...
            <div
              className="inline-block px-4 py-2 rounded-xl text-3xl sm:text-4xl lg:text-5xl tracking-wide italic"
              style={{
                background: branding.yellowAccentSoft,
                color: branding.pinkAccent,
                fontFamily: branding.studentAgencyHeadingFont,
                boxShadow: `3px 3px 0 ${branding.pinkAccent}33`,
              }}
          ...
          >
            ...
            <button
              ...
              style={{ background: branding.pinkAccent, boxShadow: `4px 4px 0 ${branding.yellowAccent}` }}
            >
              Gimana Caranya??
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Apa itu <span style={{ color: branding.pinkAccent }}>Student Agency Incubator?</span>
            </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-3">
              Kenapa Join <span style={{ color: branding.pinkAccent }}>Student Agency Incubator?</span>
            </h2>
      ...
      <section className="py-20 px-6 bg-white" id="cara-kerja">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-3">
              Cara Kerjanya <span style={{ color: branding.pinkAccent }}>5 Langkah</span>
            </h2>
      ...
      <section className="py-20 px-6" id="harga" style={{ background: '#FAFAFA' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-3">
              Investasi <span style={{ color: branding.pinkAccent }}>Paling Worth It</span><br />untuk Mahasiswa
            </h2>
            ...
            {[
              ...
              <div key={t.label} className="flex items-end gap-2 sm:gap-4">
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center font-black text-2xl sm:text-3xl text-white" style={{ background: branding.pinkAccent, boxShadow: `4px 4px 0 ${branding.yellowAccent}` }}>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto mb-10">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="rounded-3xl p-8 border-2 relative" style={{ background: 'linear-gradient(135deg,#fff0f8 0%,#fffbea 100%)', borderColor: branding.pinkAccent, boxShadow: `6px 6px 0 ${branding.yellowAccent}` }}>
              ...
              <div className="mb-5">
                <h3 className="text-xl font-black text-slate-900 mb-1">{studentAgency.pricing.earlyBird.name}</h3>
                <p className="text-sm font-semibold" style={{ color: branding.pinkAccent }}>{studentAgency.pricing.earlyBird.label}</p>
              </div>
              <div className="mb-1">
                <span className="text-5xl font-black text-slate-900">{studentAgency.pricing.earlyBird.price}</span>
              </div>
              <p className="text-sm font-bold mb-8" style={{ color: branding.pinkAccent }}>{studentAgency.pricing.earlyBird.description}</p>
              <ul className="space-y-3 mb-8">
              ...
              <a
                href={studentAgencyEarlyBirdHref}
                target="_blank"
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto bg-white rounded-2xl p-6 border-2 border-slate-100 shadow-sm">
            ...
            <div className="w-full h-4 bg-slate-100 rounded-full overflow-hidden relative">
              <div className="absolute left-0 top-0 h-full w-[25%] rounded-l-full opacity-40" style={{ background: branding.yellowAccent }} />
            </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-3">
              FAQ — <span style={{ color: branding.pinkAccent }}>Pertanyaan Umum</span>
            </h2>
          </div>
      ...
      <section className="py-24 px-6 relative overflow-hidden" id="daftar" style={{ background: '#FAFAFA' }}>
        ...
        />
        {/* Accent shapes */}
        <div className="absolute -bottom-8 -right-8 w-48 h-48 rounded-full opacity-20" style={{ background: branding.pinkAccent }} />
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <a
                href={studentAgencyRegisterHref}
                target="_blank"
                rel="noopener noreferrer"
                id="btn-daftar-wa"
                ...
                style={{ background: branding.pinkAccent, boxShadow: `5px 5px 0 ${branding.yellowAccent}` }}
              >
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-slate-500">
              {studentAgency.trustSignals.map((t) => (
                <span key={t.text} className="flex items-center gap-1.5 font-semibold">
