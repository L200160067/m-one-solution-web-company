...
export const metadata = {
  ...
  description:
    "Lihat proyek-proyek yang telah kami kerjakan — website sekolah, aplikasi organisasi, sistem informasi, dan lebih banyak. Software house Sukoharjo & Solo.",
  openGraph: {
    title: "Portofolio | M-One Solution Software House Sukoharjo",
    description:
      "Proyek website, aplikasi, dan sistem digital yang telah dikerjakan M-One Solution untuk klien di Sukoharjo, Solo, dan sekitarnya.",
  ...
  twitter: {
    ...
    description:
      "Proyek website, aplikasi, dan sistem digital dari M-One Solution — software house di Sukoharjo, Jawa Tengah.",
  },
};
