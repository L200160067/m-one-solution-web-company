    ...
    <section className="py-16 md:py-24 bg-blue-600 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[3rem] p-8 md:p-16 lg:p-20 shadow-2xl"
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-blue-600 text-lg font-bold rounded-full hover:bg-blue-50 transition-all hover:scale-105 shadow-xl"
            >
              Contact Us
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-blue-700/50 text-white border border-white/20 text-lg font-semibold rounded-full hover:bg-blue-700/80 transition-all"
            >
