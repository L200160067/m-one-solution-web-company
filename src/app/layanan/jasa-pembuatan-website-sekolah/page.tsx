...
import { BookOpen, Users, LayoutDashboard, MonitorSmartphone, CheckCircle2, MessageCircle, ArrowRight, GraduationCap } from 'lucide-react';
...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description: 'Website sekolah profesional dengan sistem PPDB online, domain .sch.id, dan support 1 tahun. Mulai Rp 1,5 Juta.',
    ...
    twitter: {
        ...
        description: 'Website sekolah profesional di Sukoharjo & Solo. Mulai Rp 1,5 Juta.',
        images: ['/og-website-sekolah.png'],
    }
};
    ...
    return (
        <main className="pt-20 min-h-screen bg-slate-50">
            ...
            <Section className="bg-slate-900 text-white relative overflow-hidden">
                ...
                <BlobBackground colorClass="bg-emerald-500/20" positionClass="top-[-20%] right-[-10%]" sizeClass="w-[50%] h-[50%]" />
                ...
                <Container>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:border-emerald-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <Section className="bg-white border-y border-slate-100">
                <Container>
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-slate-600 text-lg">
                            Kami memahami kebutuhan sekolah di era digital. Website bukan sekadar tampilan, tapi alat komunikasi dan administrasi yang harus mudah, aman, dan terjangkau.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center hover:border-emerald-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <Section id="harga" className="bg-slate-50">
                <Container>
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">Paket Harga Transparan</h2>
                        <p className="text-slate-600 text-lg">
                        ...
                        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl border border-slate-100 hover:border-blue-200 transition-all duration-300 flex flex-col hover:-translate-y-2 overflow-hidden">
                            ...
                            <div className="mb-6">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h3 className="text-2xl font-bold text-slate-900">Basic Profil</h3>
                                </div>
                                <p className="text-slate-500 text-sm">Cocok untuk sekolah yang baru ingin tampil online.</p>
                            </div>
                            <div className="mb-6">
                                <span className="text-4xl font-extrabold text-slate-900">Rp 1.5 JT</span>
                                <p className="text-slate-500 text-xs mt-1">Pembayaran tahun pertama</p>
                            </div>
                            <div className="mb-8 flex-1">
                                <ul className="space-y-3 text-slate-600 text-sm">
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0" /> Free Domain .sch.id & Hosting 1 Thn</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0" /> Desain Responsif & Modern</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0" /> Profil, Visi Misi, Fasilitas</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0" /> Berita / Blog / Pengumuman</li>
                                    <li className="flex items-start gap-3 text-slate-400"><CheckCircle2 className="w-5 h-5 shrink-0" /> (Tanpa Sistem PPDB)</li>
                                </ul>
                            </div>
                            <a href={`${waLink}&text=Halo+saya+ingin+pesan+Paket+Basic+Profil+Sekolah`} target="_blank" rel="noopener noreferrer" className="w-full block text-center py-4 rounded-xl bg-slate-900 hover:bg-blue-600 text-white font-semibold transition-all duration-300">
                                Pesan Paket Basic
                            </a>
                        </div>

                        {/* Paket Standar (Best Seller) */}
                        <div className="group relative bg-linear-to-br from-emerald-500 to-teal-600 rounded-3xl p-8 border-2 border-emerald-300 md:-translate-y-4 shadow-xl shadow-emerald-900/30 flex flex-col overflow-hidden">
                            <div className="absolute top-0 right-8 -translate-y-1/2 bg-white text-emerald-600 font-bold px-4 py-1 rounded-full text-sm shadow-lg">
                                ⭐ PALING LARIS
                            </div>
                            ...
                            <div className="relative mb-6">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h3 className="text-2xl font-bold text-white">Standar + PPDB</h3>
                                </div>
                                <p className="text-emerald-100 text-sm">Solusi lengkap untuk penerimaan siswa baru digital.</p>
                            </div>
                            <div className="relative mb-6">
                                <span className="text-4xl font-extrabold text-white">Rp 3.5 JT</span>
                                <p className="text-emerald-100 text-xs mt-1">Pembayaran tahun pertama</p>
                            </div>
                            <div className="relative mb-8 flex-1">
                                <ul className="space-y-3 text-white text-sm">
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-emerald-200 shrink-0" /> Semua Fitur Paket Basic</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-emerald-200 shrink-0" /> <b>Sistem PPDB Online Lengkap</b></li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-emerald-200 shrink-0" /> Formulir Pendaftaran & Upload Berkas</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-emerald-200 shrink-0" /> Dashboard Admin & Verifikasi</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-emerald-200 shrink-0" /> Ekspor Data Siswa ke Excel</li>
                                </ul>
                            </div>
                            <a href={`${waLink}&text=Halo+saya+ingin+pesan+Paket+Standar+PPDB+Sekolah`} target="_blank" rel="noopener noreferrer" className="relative w-full block text-center py-4 rounded-xl bg-white text-emerald-600 hover:bg-emerald-50 font-bold transition-all duration-300 shadow-lg">
                                Pesan Paket Standar
                            </a>
                        </div>
                        ...
                        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl border border-slate-100 hover:border-purple-200 transition-all duration-300 flex flex-col hover:-translate-y-2 overflow-hidden">
                            ...
                            <div className="mb-6">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h3 className="text-2xl font-bold text-slate-900">Premium SIAKAD</h3>
                                </div>
                                <p className="text-slate-500 text-sm">Untuk sekolah yang butuh sistem ujian online & absensi.</p>
                            </div>
                            <div className="mb-6">
                                <span className="text-4xl font-extrabold text-slate-900">Rp 7.5 JT</span>
                                <p className="text-slate-500 text-xs mt-1">Pembayaran tahun pertama</p>
                            </div>
                            <div className="mb-8 flex-1">
                                <ul className="space-y-3 text-slate-600 text-sm">
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-purple-500 shrink-0" /> Semua Fitur Paket Standar</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-purple-500 shrink-0" /> Manajemen Guru & Jadwal</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-purple-500 shrink-0" /> Ujian Online (CBT) Terintegrasi</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-purple-500 shrink-0" /> Sistem E-Rapor & Nilai</li>
                                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-purple-500 shrink-0" /> Integrasi Absensi Digital</li>
                                </ul>
                            </div>
                            <a href={`${waLink}&text=Halo+saya+ingin+pesan+Paket+Premium+SIAKAD+Sekolah`} target="_blank" rel="noopener noreferrer" className="w-full block text-center py-4 rounded-xl bg-slate-900 hover:bg-purple-600 text-white font-semibold transition-all duration-300">
                                Pesan Paket Premium
                            </a>
                        </div>
                    </div>
            ...
            <Section className="bg-emerald-50">
                <Container>
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">Apa Kata Sekolah yang Sudah Bertransformasi?</h2>
                        <p className="text-slate-600 text-lg">
                            Bergabung bersama sekolah-sekolah yang kini memiliki kanal informasi resmi dan administrasi digital yang lebih rapi.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                quote: 'Website sekolah kami kini menjadi rujukan wali murid. Pengumuman dan PPDB jadi lebih terorganisir tanpa antre panjang.'
                            },
                            {
                                name: 'Bu Yuni',
                                role: 'Operator SMP Negeri',
                                quote: 'Sistem PPDB online dari M-One sangat membantu. Wali murid bisa daftar dari rumah, kami tinggal verifikasi datanya.'
                            },
                            {
                                name: 'Pak Bambang',
                                role: 'Admin SMA Swasta',
                                quote: 'Tampilan website profesional dan mudah diupdate. Support timnya cepat dan sabar mengajari cara mengelola konten.'
                            }
                        ].map((testi, i) => (
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            { Q: "Apakah kami bisa request fitur tambahan?", A: "Bisa. Jika fitur yang Anda butuhkan di luar paket, kami bisa diskusikan estimasi tambahan biayanya secara transparan." },
                            { Q: "Apakah domain .sch.id sudah termasuk?", A: "Ya, kami bantu proses domain resmi .sch.id sesuai persyaratan Kemendikbud. Prosesnya kami bantu step-by-step." },
                        ].map((faq, i) => (
            ...
            <Section className="bg-slate-900 text-white">
                <Container>
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-bold mb-6">Siap Miliki Website Sekolah Profesional?</h2>
                        <p className="text-slate-400 text-lg mb-10">
                            Jangan biarkan informasi sekolah tertinggal di era digital. Konsultasikan kebutuhan sekolah Anda secara GRATIS.
                        </p>
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-slate-400">
                            ...
                            <Link href="/portfolio" className="hover:text-white transition-colors flex items-center gap-2">
