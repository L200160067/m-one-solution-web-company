...
export const metadata: Metadata = {
  ...
  description:
    "Jasa pembuatan website, aplikasi mobile, dan sistem ERP di Sukoharjo & Solo. Tim profesional siap bantu bisnis Anda. Konsultasi GRATIS!",
  keywords: [
  ...
  openGraph: {
    title: "Jasa Pembuatan Website & Aplikasi Sukoharjo Solo | M-One Solution",
    description:
      "Jasa pembuatan website, aplikasi mobile, dan sistem ERP di Sukoharjo & Solo. Konsultasi GRATIS — hubungi sekarang!",
  ...
  twitter: {
    ...
    title: "Jasa Pembuatan Website & Aplikasi Sukoharjo Solo | M-One Solution",
    description:
      "Website, aplikasi mobile, dan sistem ERP dari software house terpercaya di Sukoharjo & Solo.",
    images: ["/og-image.png"],
  },
};
      ...
      <Container className="mt-20 pt-10 border-t border-slate-200">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-6">
            Butuh Solusi IT Berskala Besar?
          </h2>
          <p className="text-lg text-slate-600">
            Selain paket instan di atas, tim Software House kami siap membangun
            arsitektur sistem kustom tingkat lanjut — mulai dari aplikasi mobile
            hingga ERP yang disesuaikan dengan proses bisnis Anda.
          </p>
        </div>
